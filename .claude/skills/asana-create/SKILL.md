...
9. **Rapporteer terug.** Noem elk aangemaakt ticket als `KOZ-N: Titel` met de Asana-task-URL (`https://app.asana.com/1/<workspace.gid>/project/<project.gid>/task/<task_gid>`), in het Nederlands.
...
| Notes format | Doel / Verwacht eindproduct / Out of scope / Definition of Done / Kernpunten |
