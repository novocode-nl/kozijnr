 ...
 *
 * Rendered only for the admin context (KOZ-31 rework): `/users` is a
 * single shared route for both admin.<domein> and {tenant}.<domein> — see
 * `page.tsx` in this directory, which picks between this component and
 * `OwnUsersPage` via `getAppContext()`.
 */
